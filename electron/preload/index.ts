...
const api: PolemicaApi = {
  ...
  setLobbyFilter: (id: string) => ipcRenderer.invoke(IpcChannels.LOBBY_FILTER_SET, id),
  getLobbyFilter: () => ipcRenderer.invoke(IpcChannels.LOBBY_FILTER_GET),
  ...
  resumeSession: (accountId?: string) => ipcRenderer.invoke(IpcChannels.AUTH_RESUME, accountId),
  enterApp: () => ipcRenderer.invoke(IpcChannels.AUTH_ENTER_APP),
  logout: () => ipcRenderer.invoke(IpcChannels.AUTH_LOGOUT),
  removeAccount: (accountId: string) =>
    ipcRenderer.invoke(IpcChannels.AUTH_REMOVE_ACCOUNT, accountId),
